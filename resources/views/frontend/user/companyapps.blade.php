...
<a href="">
 ...
 <div class="col-sm-3 margins dropdown" style="margin-bottom: 20px;">
    ...
    <a href="http://agency.local.com">Agency</a>
  <div id="childdrop3" class="dropdown">
    ...
    <a href="http://forward.local.com/">Esl</a>
    <a href="http://forward.local.com/">Freightwell</a>
    </div>
    </div>
    ...
    <a href="http://esl-logistics.wizag.co.ke:9000/login?data={{ \Illuminate\Support\Facades\Auth::user() }} ">Esl</a>
    <a href="http://sovereign-logistics.wizag.co.ke:9000/">Sovereign</a>
    </div>
    </div>
